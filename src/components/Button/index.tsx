...
export function Button({
  ...
  const buttonClasses = [buttonVariants[variant], buttonSizes[size], 'flex items-center justify-center cursor-pointer transition disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed', props.className].join(" ");
